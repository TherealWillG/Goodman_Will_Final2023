...
were from the source code that was given to us during the first videogame project.
'''
# 
...
# For some reason however, I cannot get the images to load in when I place them in specific folders 
